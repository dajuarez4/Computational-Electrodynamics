...
- `Laplace's Equation`: [Notebook](./notebooks/Laplace%27s%20equation.ipynb), [Jackson 2.12 Notebook](./notebooks/Jackson%202.12%20Poisson%20Integral%20for%20a%20Cylinder.ipynb), [Problem Set](./problems/Laplace_equation.pdf), [Formula Sheet](./Formula%20Sheet/laplace_formula_sheet.pdf)
