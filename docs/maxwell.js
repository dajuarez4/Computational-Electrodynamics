(function () {
  ...
  widget.innerHTML = [
    ...
    '          <h3 class="maxwell-sidecar__title">Ask for a topic, a page, or one direct file.</h3>',
    '          <p class="maxwell-sidecar__text">Start with topics, notes, or visuals. Use search only when you already know what you want.</p>',
    "        </div>",
    "      </div>",
